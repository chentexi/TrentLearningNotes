...
![image-20220705003414705](../../../Strive/TrentLearningNotes/Notes/Image/image-20220705003414705.png)
...
![image-20220705003844027](../../../Strive/TrentLearningNotes/Notes/Image/image-20220705003844027.png)

==spring什么时候创建对象==

​	创建spring容器对象的时候,会读取配置文件,创建文件中声明的Java对象,默认把文件中声明的对象全部创建出来
...
![image-20220705233416387](../../../Strive/TrentLearningNotes/Notes/Image/image-20220705233416387.png)

### 创建非自定义类

![image-20220706232356202](../../../Strive/TrentLearningNotes/Notes/Image/image-20220706232356202.png)

![image-20220706232536150](../../../Strive/TrentLearningNotes/Notes/Image/image-20220706232536150.png)
...
<bean id="myFile" class="java.io.File">
    ...
    <constructor-arg name="child"  value="资料.word"/>
</bean>
```
...
![image-20220707000356681](../../../Strive/TrentLearningNotes/Notes/Image/image-20220707000356681.png)
...
![image-20220707000559073](../../../Strive/TrentLearningNotes/Notes/Image/image-20220707000559073.png)
...
@Component    创建普通java对象

@Respository  创建dao对象,持久层对象,表示对象能访问数据库。

@Service      创建service对象,业务层对象,处理业务逻辑,具有事务能力

@Controller   创建控制器对象,接收请求,显示请求的处理结果.视图层对象
...
​	 如果要使用byName赋值则需要下面两个注解一起使用:

​     	@Autowired @Qualifier : 使用byName

 ![image-20220222000632876](Image/image-20220222000632876.png)
...
![image-20220222002143294](Image/image-20220222002143294.png)
...
![image-20201024113735575](Image/image-20201024113735575.png)
...
![image-20220223002250787](Image/image-20220223002250787.png)
...
![image-20220417231733768](Image/image-20220417231733768.png)
...
![image-20220417233413738](Image/image-20220417233413738.png)
